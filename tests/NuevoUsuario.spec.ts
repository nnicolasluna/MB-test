...
test('NuevoUsuario', async ({ page }) => {
  ...
  //await page.getByRole('button', { name: ' Agregar Usuario' }).click();
  await page.getByRole('textbox', { name: 'Nombres' }).fill('Pruebatres');
  await page.getByRole('textbox', { name: 'Apellido Paterno' }).click();
  await page.getByRole('textbox', { name: 'Apellido Paterno' }).fill('pruebatres');
  await page.getByRole('textbox', { name: 'Apellido Materno' }).click();
  await page.getByRole('textbox', { name: 'Apellido Materno' }).fill('pruebatres');
  await page.getByRole('textbox', { name: 'Dirección' }).click();
  await page.getByRole('textbox', { name: 'Dirección' }).fill('calle pruebatres');
  await page.getByRole('textbox', { name: 'CI', exact: true }).click();
  await page.getByRole('textbox', { name: 'CI', exact: true }).fill('861854');
  await page.getByRole('textbox', { name: 'Correo Electrónico' }).click();
  await page.getByRole('textbox', { name: 'Correo Electrónico' }).click();
  //await page.getByRole('textbox', { name: 'Correo Electrónico' }).fill('xivaj19700@hosintoy.com');
  //await page.getByRole('textbox', { name: 'Correo Electrónico' }).click();
  await page.getByRole('textbox', { name: 'Correo Electrónico' }).fill('fohos18059@hosintoy.com');
  await page.getByRole('textbox', { name: 'Teléfono' }).click();
  await page.getByRole('textbox', { name: 'Teléfono' }).fill('7849865219');
  ...
  await page.getByRole('textbox', { name: 'Nombre de Usuario' }).fill('pruebastres');
